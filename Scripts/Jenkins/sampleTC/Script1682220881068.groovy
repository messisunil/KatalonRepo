...
WebUI.setText(findTestObject('Object Repository/jenkins/Page_actiTIME - Login/input_trainee_username'), 'admin')

WebUI.setEncryptedText(findTestObject('Object Repository/jenkins/Page_actiTIME - Login/input_trainee_pwd'), 'RVfeMFa65gU=')
